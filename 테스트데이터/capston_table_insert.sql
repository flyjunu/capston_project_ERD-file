...
INSERT INTO activity_postings (
    ...
    2, '공모전', '제15회 대한민국 공공데이터 활용 창업경진대회', '행정안전부',
...
-- 13. 대/내외 활동 팀 모집 게시판 테스트 데이터 삽입
...
-- 14. 대/내외 활동 팀 지원자 목록 테스트 데이터 삽입
...
-- 16. 공지사항 테이블 테스트 데이터 삽입
INSERT INTO notices (notice_id, notice_title, notice_content) VALUES (1, '시스템 정기 점검 안내 (9/22)', '2025년 9월 22일 월요일 오전 2시부터 4시까지 서비스 안정화를 위한 시스템 정기 점검이 진행됩니다. 이용에 불편을 드려 죄송합니다.'); 
INSERT INTO notices (notice_id, notice_title, notice_content) VALUES (2, '제3회 개발자 컨퍼런스 개최 안내', '오는 10월 15일, 제3회 개발자 컨퍼런스가 개최됩니다. 상세 내용 및 참가 신청은 공고 게시판을 확인해주세요. 많은 참여 바랍니다.');

-- 17. 직종별 게시판 테스트 데이터 삽입
