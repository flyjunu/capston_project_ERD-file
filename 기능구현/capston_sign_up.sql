...
INSERT INTO user_certificates (user_certificate_id, user_id, certificate_id, issue_date, expiration_date, certificate_number, score)
    VALUES (user_cert_seq.NEXTVAL, :user_id , :cert_id, :issue_date, :exp_date, :cert_num, :cert_score);

-- (4) 유저 학과 테이블에 데이터 삽입
INSERT INTO user_departments (user_id, department_id, major_type) VALUES (:user_id, :dept_id, :major_type);
...
VALUES (activities_seq.NEXTVAL, :user_id, :activity_type, :activity_name, :start_date, :end_date, :activity_description );
